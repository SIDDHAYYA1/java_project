...
public class FileOperations {
	...
	public static void displayAllFiles(String path) {
		...
		List<String> filesListNames = FileOperations.listFilesInDirectory(path, new ArrayList<String>());
	...
	public static void createFile(String fileToAdd, Scanner sc) {
		...
		try {
			...
			if (choice.equals("y")) {
				...
				System.out.println("You can read the file content using text editor.");
			}

		} catch (IOException e) {
			System.out.println("Failed to create file " + fileToAdd+ "file already exists!!!");
